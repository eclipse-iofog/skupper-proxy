...
function Proxy(config, bridgehost, ioFogOptions) {
  ...
  if (bridgeconfig) {
    switch (bridgeconfig.type) {
      ...
      case "amqp_to_http2":
        return bridges.amqp_to_http2(bridgeconfig.source, bridgehost, bridgeconfig.target, ioFogOptions);
      case "amqp_to_tcp":
      ...
      case "http2_to_amqp":
        return bridges.http2_to_amqp(bridgeconfig.source, bridgeconfig.target, ioFogOptions);
      case "tcp_to_amqp":
