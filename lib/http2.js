...
function Ingress (port, address, ioFogOptions = {}) {
    this.port = port;
...
function Egress (host, port, address, ioFogOptions = {}) {
    this.host = host;
    this.port = port;
    this.address = address;
    this.routerHost = ioFogOptions.routerHost || 'localhost';
...
module.exports.ingress = function (port, address, ioFogOptions) {
    return new Ingress(port, address, ioFogOptions);
};

module.exports.egress = function (address, host, port, ioFogOptions) {
    return new Egress(host, port, address, ioFogOptions);
};
