...
function AmqpToHttpBridge(address, host, port, ioFogOptions = {}) {
    ...
    this.connection = container.connect({ host: this.routerHost, port: this.routerPort });
...
function HttpToAmqpBridge(port, address, ioFogOptions = {}) {
    ...
    this.client = rclient.create(container.connect({ host: this.routerHost, port: this.routerPort }), address);
...
AmqpToTcpBridge.prototype.create_connection = function () {
    this.connection = this.container.connect({ host: this.routerHost, port: this.routerPort });
...
TcpToAmqpBridge.prototype.incoming_connection = function (socket) {
    ...
    var self = this;
    socket.pause();
    var connection = this.container.connect({ host: this.routerHost, port: this.routerPort });
    var self = this;
...
module.exports.amqp_to_http2 = function (address, host, port, ioFogOptions) {
    return myhttp2.egress(address, host, port, ioFogOptions);
};
...
module.exports.http2_to_amqp = function (port, address, ioFogOptions) {
    return myhttp2.ingress(port, address, ioFogOptions);
};
